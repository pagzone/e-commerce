...
export default function Home() {
  return (
     <div className="h-auto flex flex-col gap-y-6 px-6 ">
        <div className="h-96">
          <FeaturedProducts />
        </div>

        <div className="h-auto px-2 flex flex-col gap-2">
          <div className="flex justify-between items-center">
            <h1 className="text-xl font-bold">Products</h1>
             <Link href='/' className="hover:underline">See all</Link>
          </div>
           
          <div className="h-auto flex flex-wrap gap-y-6 py-2 justify-between
