...
const Footer = () => {
  return (
    <div className="h-68 flex flex-col">
      <div className="p-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mx-2 md:mx-14 lg:mx-24 xl:mx-44">
      ...
      <div className="h-16 flex items-center justify-center w-full bg-slate-50 ">
        <p className="text-sm text-gray-700">
          ...
          <span className="font-semibold text-gray-800">Pagzone</span>
        </p>
      </div>
    </div>
  );
